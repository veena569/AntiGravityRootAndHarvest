  ...
  const variants: VariantOption[] = isOil
    ? [
        ...
        },
        {
          ...
          originalPrice: p500Orig + glassDiff,
          unitPriceText: `Rs. ${(p500 + glassDiff) * 2}.00 / L`,
        },
        {
          id: "1l-plastic",
          size: "1 L",
        ...
        },
        {
          ...
          label: "1L Tin Metal",
          price: p1L + tinDiff,
          originalPrice: p1LOrig + tinDiff,
          unitPriceText: `Rs. ${p1L + tinDiff}.00 / L`,
        },
        {
          id: "2l-plastic",
          size: "2 L",
        ...
        },
        {
          ...
          label: "2L Tin Metal",
          price: p2L + tinDiff,
          originalPrice: p2LOrig + tinDiff,
          unitPriceText: `Rs. ${Math.round((p2L + tinDiff) / 2)}.00 / L`,
        },
        {
          id: "5l-plastic",
          size: "5 L",
          bottleType: "Plastic Bottle",
          label: "5L Plastic Can",
          price: p5L,
        ...
        },
        {
          ...
          label: "5L Tin Metal",
          price: p5L + tinDiff,
          originalPrice: p5LOrig + tinDiff,
          unitPriceText: `Rs. ${Math.round((p5L + tinDiff) / 5)}.00 / L`,
        },
      ]
    : product.sizes.map((s) => ({
