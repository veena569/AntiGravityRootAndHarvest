...
import { ArrowRight, Leaf, Shield, Cpu, Heart, MapPin, Award } from "lucide-react";
    ...
    <>
      ...
      <main className="min-h-screen bg-brand-bg py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-20 md:space-y-32">
          {/* Breadcrumbs */}
          <nav aria-label="Breadcrumb" className="text-xs text-dark/60">
          ...
          <div className="text-center space-y-6 max-w-3xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-serif tracking-tight text-forest font-light leading-snug">
              Root & Harvest was born from a simple belief — the food we choose for our family should be{" "}
              <span className="italic font-normal text-gold">pure, honest and trustworthy.</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-6 relative aspect-[4/5] max-w-md mx-auto w-full shadow-lg border border-forest/5 overflow-hidden rounded-sm bg-white">
              <Image
                ...
                alt="Root & Harvest founders family standing in agricultural fields"
                fill
                priority
            ...
            <div className="lg:col-span-6 space-y-8 text-left leading-relaxed text-dark/85 font-light text-base md:text-lg">
              <div className="space-y-2">
                <span className="text-xs uppercase tracking-[0.2em] text-gold font-semibold block">
                  OUR STORY
                </span>
                <h2 className="text-3xl font-serif text-forest tracking-tight font-semibold">
                  The Journey from Code to Crops
                </h2>
              </div>
              ...
              <div className="space-y-6 text-sm md:text-base">
                ...
                <h3 className="text-xl md:text-2xl font-serif font-semibold text-forest uppercase tracking-wider pt-2">
                  It Started in Our Own Kitchen
                </h3>
                <p>
                  For nearly two years, every trip to our hometown meant bringing back something simple but important —{" "}
                  <strong>traditionally made oil for our family.</strong>
                </p>
                <p>
                ...
                <p>As parents, it made us ask a simple question:</p>
                <blockquote className="font-serif text-lg italic text-forest border-l-2 border-gold pl-4 py-1 my-2">
                ...
                <h3 className="text-lg font-serif font-semibold text-forest uppercase tracking-wider pt-2">
          ...
          <div className="bg-white border border-forest/5 p-8 md:p-12 text-center space-y-12 shadow-sm rounded-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
              {coreValues.map((val, idx) => (
                <div
                  key={idx}
                  className="space-y-4 p-6 bg-brand-bg/10 border border-forest/5 rounded-sm hover:border-gold/30 transition-all"
                >
                  <div className="w-12 h-12 rounded-full bg-brand-bg flex items-center justify-center text-forest">
                    {val.icon}
                  </div>
                  <h4 className="text-lg font-semibold text-forest font-serif">
                    {val.title}
                  </h4>
                  <p className="text-xs md:text-sm text-dark/75 leading-relaxed font-light whitespace-pre-line">
                    {val.desc}
                  </p>
                </div>
              ))}
          ...
          <div className="relative py-16 md:py-24 bg-forest text-brand-bg text-center overflow-hidden rounded-sm">
            ...
            <div className="max-w-3xl mx-auto px-6 space-y-6 relative z-10">
              ...
              <h3 className="text-2xl md:text-4xl font-serif italic font-light leading-snug">
                "We trace every bottle of Wood Pressed Oil. From soil quality checks to the wood-pressed speeds of extraction, you will know exactly what goes into your kitchen."
              </h3>
              <div className="pt-4 space-y-1">
                <span className="text-xs uppercase tracking-widest font-semibold block">
                  Root & Harvest Founders
                </span>
                <span className="text-[10px] text-brand-bg/60">
                  Farming Heritage & Tech Pioneers | Hyderabad, India
                </span>
              </div>
              <div className="pt-6 flex flex-wrap items-center justify-center gap-4">
                ...
                <Link
                  href="/contact"
                  className="px-6 py-3 border border-brand-bg/30 text-brand-bg uppercase tracking-widest text-[10px] font-semibold hover:bg-brand-bg hover:text-forest transition-all"
                >
                  Contact Us
                </Link>
